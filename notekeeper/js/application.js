$(function(){
  ...
  (function(app){
    ...
    var $note = $('#note');
    var $ul = $('#notesList');
    var li = '<li><a href="#pgNotesDetail?title=LINK">ID</a><a href="" class="delete" data-href="ID">Delete</a></li>';
    ...
    app.bindings = function(){
      ...
      $(document).delegate('#notesList a:first', 'click',function(e){
        e.preventDefault();
